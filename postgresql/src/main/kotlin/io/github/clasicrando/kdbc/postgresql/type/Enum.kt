...
internal class EnumTypeDescription<E : Enum<E>>(pgType: PgType, kType: KType, values: Array<E>) :
    PgTypeDescription<E>(dbType = pgType, kType = kType) {
     ...
     *
     * [pg source
     * code](https://github.com/postgres/postgres/blob/874d817baa160ca7e68bee6ccc9fc1848c56e750/src/backend/utils/adt/enum.c#L155)
     *
     ...
     *
     * [pg source
     * code](https://github.com/postgres/postgres/blob/874d817baa160ca7e68bee6ccc9fc1848c56e750/src/backend/utils/adt/enum.c#L221)
     *
     * @throws io.github.clasicrando.kdbc.core.column.ColumnDecodeError if a variant of [E] cannot
     *   be found by [Enum.name] from the decoded [String] value
     */
