 ...
 * [io.github.clasicrando.kdbc.core.connection.BlockingConnection.begin] and handle the transaction
 * state of your connection yourself. In that case, any sync message sent to the server does not
 * cause implicit transactional behaviour.
 *
