...
class PgCopyEncodeBuffer internal constructor(private val typeCache: PgTypeCache) : AutoCloseable {
    ...
    private fun <T : Any> encodeNonNullValue(value: T, kType: KType) {
        ...
        innerBuffer.writeLengthPrefixedInt { description.encode(value, this) }
    }
