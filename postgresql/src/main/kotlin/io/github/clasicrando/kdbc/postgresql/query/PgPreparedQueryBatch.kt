...
/**
 * Postgresql implementation of a [io.github.clasicrando.kdbc.core.connection.Connection].
 ...
 * [io.github.clasicrando.kdbc.core.connection.Connection.begin] and handle the
 ...
 */
internal class PgPreparedQueryBatch(
    connection: PgConnection,
) : BasePreparedQueryBatch<PgConnection>(connection) {
