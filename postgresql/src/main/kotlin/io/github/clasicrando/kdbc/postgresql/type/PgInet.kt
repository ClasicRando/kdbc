 ...
 */
public sealed class PgInet(public val address: ByteArray, public val prefix: UByte) {
    /**
     * IPV6 variant of a [PgInet] value where [address] is a 16 [Byte] value and [prefix] ranges
     * from 0 to 128 (default is 128).
     */
    public class Ipv6(address: ByteArray, prefix: UByte) : PgInet(address, prefix) {
        init {
     ...
     */
    public class Ipv4(address: ByteArray, prefix: UByte) : PgInet(address, prefix) {
        init {
    ...
    public fun toInetAddress(): InetAddress {
    ...
    public companion object {
         ...
         */
        public fun parse(address: String): PgInet {
         ...
         *   [Inet6Address]
         */
        public fun fromInetAddress(inetAddress: InetAddress, prefix: UByte?): PgInet {
