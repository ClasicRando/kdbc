...
internal object LocalDateTypeDescription :
    ...
    /**
     * Writes the number of days until the [postgresEpochDateTime] as an [Int] to the argument
     * buffer.
     *
    ...
    override fun decodeBytes(value: PgValue.Binary): LocalDate {
        ...
        return postgresEpochDateTime.plus(days.toLong(), ChronoUnit.DAYS)
    }
