 ...
 * encounters and error either in its internal process or as a result of a message passed from the
 * frontend. The contents of the message is a common [InformationResponse] packet that is using
