 ...
 * holds a collection of [ConnectionPool] instances per connect options provided. Then each vendor's
 * [Connection] will have a static method that calls this [acquireConnection] to fetch the connect
 * option's [ConnectionPool] and acquire a [Connection] from that pool. If there is no
