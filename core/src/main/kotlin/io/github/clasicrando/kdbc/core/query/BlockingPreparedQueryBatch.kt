...
/**
 * API to perform zero or more queries against a database [BlockingConnection] where each query is
 * a [BlockingPreparedQuery]. Although this API is generally used for executing the same query with
