...
/**
 * [Connection] entry within a connection pool. Tracks the creation [Instant] of the connection and
 * the [Instant] of the last time the pool was accessed. [lastAccessed] is only updated once the
