 ...
 * be thrown to signify the connection is in an invalid/unknown state and the underlining connection
 * should be terminated.
 */
public class UnexpectedTransactionState(inTransaction: Boolean) :
