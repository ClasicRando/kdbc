...
/**
 * API to perform a single query against a database [BlockingConnection] with no parameters.
 *
 ...
 * recommended to use a [PreparedQuery] since a [BlockingQuery] is not guaranteed to create or
 * cache a query plan for future calls of this same SQL query.
 */
