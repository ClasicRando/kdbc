...
public object JavaBigDecimalRowParser : RowParser<java.math.BigDecimal> {
...
public object JavaLocalDateTimeRowParser : RowParser<java.time.LocalDateTime> {
...
public object DateTimeRowParser : RowParser<DateTime> {
