...
open class PgBenchmarkBlockingMultiJdbc {
    private var id = 0
    private val dataSource: DataSource by lazy { getJdbcDataSource() }
    private val executor: Executor by lazy { Executors.newWorkStealingPool() }
    private val completionService by lazy { ExecutorCompletionService<Unit>(executor) }
